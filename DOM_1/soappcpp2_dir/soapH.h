/* soapH.h
   Generated by gSOAP 2.8.14 from ../add.h
...
#define soap_write_ns2__add(soap, data) ( soap_begin(soap), soap_serialize_ns2__add(soap, data), soap_begin_send(soap) || soap_put_ns2__add(soap, data, "ns2:add", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_ns2__addResponse(soap, data) ( soap_begin(soap), soap_serialize_ns2__addResponse(soap, data), soap_begin_send(soap) || soap_put_ns2__addResponse(soap, data, "ns2:addResponse", NULL) || soap_end_send(soap), soap->error )
#endif
